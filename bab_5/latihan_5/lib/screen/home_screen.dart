...
import 'package:latihan_5/screen/detail_screen.dart';
import 'package:latihan_5/screen/edit_profile_screen.dart';
    ...
    if (response.statusCode == 200) {
      try {
        ...
        return data.map<Map<String, String>>((item) {
          return {
            'imageUrl':
                'https://events.hmti.unkhair.ac.id/storage/'+Uri.encodeFull(item['image']),
      ...
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget> [
            DrawerHeader(
              child: Text(
                'Pengaturan', style: TextStyle(color: Colors.white),
              ),
